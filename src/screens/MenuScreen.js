                  ...
                  <View style={styles.menuItem}>
                    ...
                    {isHalfSelected && (
                      <View style={styles.halfBadge}>
                        <Text style={styles.halfText}>0,5</Text>
                      </View>
                    )}
                    {quantity > 0 && (
                    ...
                    {category === 'Pizzas' ? (
                      <TouchableOpacity
                        style={[styles.addButton, isHalfSelected && styles.selectedButton]}
                        onPress={() => addPizzaToCart(item)}
                      >
                        <Text style={styles.addButtonText}>
                          {isHalfSelected ? 'Selecionado' : 'Escolher'}
                        </Text>
                      </TouchableOpacity>
                    ) : (
